		...
		<div className='section'>
			...
			<Grid>
				<Element
					...
					whileInView='show'
				>
					<Title>A BUILDING FIRST COMMUNITY</Title>
					<Content>
						We started working on June 2021 with a dream: making the best product we could, and provide a platform to all.{' '}
						{/*<a
							className='link'
							href='http://'
							target='_blank'
				...
				>
					<Title>
					<Content>Your ID inside Solarity</Content>
						<B>FREE PASSPORT</B> <br />
					</Title>
					<Content>Claim your 3D Identity in the Solarity society</Content>
				</Element>
				<Element
					className='c'
					variants={fromRightVar}
					...
					whileInView='show'
				>
					<Content>Your spot inside Solarity</Content>
					<Title>
						<B>3,142</B> PODS
					</Title>
					<Content>
						Create your own gallery, embed it in your Twitter profile and host events  {''}
				...
				>
					<Title>
						<B>1,618</B> <br />
						<B style={{ fontWeight: variables.font.regular }}>Bundles</B>
						<Content>Passport Premium + Pods, and much more</Content>
